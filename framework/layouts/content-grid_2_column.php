...
<article id="post-<?php the_ID(); ?>" <?php post_class('col-md-6 col-sm-6 grid grid_2_column'); ?>>
		...
		<div class="featured-thumb col-md-12">
			<?php if (has_post_thumbnail()) : ?>	
				<a href="<?php the_permalink() ?>" title="<?php the_title() ?>"><?php the_post_thumbnail('verge-pop-thumb'); ?></a>
			<?php else: ?>
		...
		<div class="out-thumb col-md-12">
			<header class="entry-header">
				...
				<div class="postedon"><?php verge_posted_on(); ?></div>
				<span class="entry-excerpt"><?php echo substr(get_the_excerpt(),0,200).(get_the_excerpt() ? "..." : "" ); ?></span>
				<span class="readmore"><a class="hvr-underline-from-center" href="<?php the_permalink() ?>"><?php _e('Read More','verge'); ?></a></span>
			</header><!-- .entry-header -->
		</div><!--.out-thumb-->
